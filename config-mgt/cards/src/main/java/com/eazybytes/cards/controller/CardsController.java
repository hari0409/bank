...
import com.eazybytes.cards.config.CardAppnConfig;
...
public class CardsController {
        ...
        @Autowired
        private CardAppnConfig cardAppnConfig;
        ...
        public ResponseEntity<?> getBuildInfo() {
                return ResponseEntity.status(HttpStatus.OK).body(appnBuildInfo);
        }
        ...
        public ResponseEntity<?> getCardsAppnContactInfo() {
                return ResponseEntity.status(HttpStatus.OK).body(cardAppnConfig);
        }
