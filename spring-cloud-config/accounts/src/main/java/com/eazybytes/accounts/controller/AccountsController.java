...
import com.eazybytes.accounts.config.ConfigHandler;
...
public class AccountsController {
        ...
        @Operation(summary = "This is used to get the Build Version of the appn.", description = "This method can be used to get the Build Version of the appn.")
        @ApiResponses({
                        @ApiResponse(description = "Get the Build Version of the appn", responseCode = "200")
        })
        ...
        @Operation(summary = "This is used to get the Java Version of the appn.", description = "This method can be used to get the Java Version of the appn.")
        @ApiResponses({
                        @ApiResponse(description = "Get the Java Version of the appn", responseCode = "200")
        })
        ...
        public ResponseEntity<?> getContactInfo() {
                return ResponseEntity.status(HttpStatus.OK).body(configHandler);
        }
}
